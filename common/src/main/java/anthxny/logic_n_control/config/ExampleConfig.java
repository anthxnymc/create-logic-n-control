package anthxny.logic_n_control.config;

import anthxny.logic_n_control.config.client.CClient;
import anthxny.logic_n_control.config.common.CCommon;
import anthxny.logic_n_control.config.server.CServer;
...
public class ExampleConfig {
	...
	public static BaseConfigScreen createConfigScreen(Screen parent) {
		BaseConfigScreen.setDefaultActionFor(LogicNControl.ID, (base) ->
		...
		return new BaseConfigScreen(parent, LogicNControl.ID);
	}
