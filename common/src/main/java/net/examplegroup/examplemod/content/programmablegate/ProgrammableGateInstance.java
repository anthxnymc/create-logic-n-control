...
public class ProgrammableGateInstance extends BlockEntityInstance<ProgrammableGateBlockEntity> implements TickableInstance
{
    ...
    public ProgrammableGateInstance(MaterialManager materialManager, ProgrammableGateBlockEntity blockEntity) {
